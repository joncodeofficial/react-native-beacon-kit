...
- [x] Real background scanning via foreground service
...
### iOS
- [ ] `CLLocationManager` + `CLBeaconRegion` ranging and monitoring
- [ ] Background monitoring with ~10s ranging bursts on region entry
- [ ] Permissions: `NSLocationAlwaysAndWhenInUseUsageDescription`, `NSLocationWhenInUseUsageDescription`
- [ ] "Location updates" background mode in Xcode capabilities
- [ ] API mirrors Android exactly — JS code is platform-agnostic
